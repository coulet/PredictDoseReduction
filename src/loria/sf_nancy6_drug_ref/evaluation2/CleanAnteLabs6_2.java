...
public class CleanAnteLabs6_2 {
	...
	static String DRUG_CHG_ANNOT_DB	  = "user_x.drug_change_"+YEAR+"_ante_lab_db";
	static String DRUG_CHG_ANNOT_MS	  = "user_x.drug_change_"+YEAR+"_ante_lab_ms";
	
	static String DOSE_DOWN_PHENO 	 = "user_x.dose_down_"+YEAR+"_ante_lab_p450_all";
	static String DOSE_UP_PHENO 	 = "user_x.dose_up_"+YEAR+"_ante_lab_p450_all";
	static String DRUG_CHG_PHENO_DB	 = "user_x.drug_change_"+YEAR+"_ante_lab_db_p450_all";
	static String DRUG_CHG_PHENO_MS	 = "user_x.drug_change_"+YEAR+"_ante_lab_ms_p450_all";
	...
	public static void main(String[] args) throws SQLException, ClassNotFoundException, UnsupportedEncodingException {
    	...
    	for(String c: allDrugClass){
		    ...
		    //int k__  = ehr.getAnteK(DRUG_CHG_ANNOT_DB, "", singleDrug, mbr);
		    //int k___ = ehr.getAnteK(DRUG_CHG_ANNOT_MS, "", singleDrug, mbr);
		    ...
		    if(upOrDown.equals(DOWN)){
		    	ehr.cleaningFirstStep(DOSE_DOWN_PHENO_REDUCED0, DOSE_DOWN_PHENO_REDUCED1, c, alphaBar, rrMin, rrMax, singleDrug);
			}else if(upOrDown.equals(UP)){
				ehr.cleaningFirstStep(DOSE_UP_PHENO_REDUCED0, DOSE_UP_PHENO_REDUCED1, c, alphaBar_, rrMin, rrMax, singleDrug);
			}	
		    //ehr.cleaningFirstStep(DRUG_CHG_PHENO_DB, DRUG_CHG_PHENO_DB_REDUCED1, c, alphaBar__, rrMin);
		    //ehr.cleaningFirstStep(DRUG_CHG_PHENO_MS, DRUG_CHG_PHENO_MS_REDUCED1, c, alphaBar___, rrMin);
