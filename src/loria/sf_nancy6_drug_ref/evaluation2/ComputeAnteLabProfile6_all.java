...
public class ComputeAnteLabProfile6_all {
	...
	static String DOSE_CHG_ANNOT 	 = "user_x.dose_change_"+YEAR+"_ante_lab";
	static String DRUG_CHG_ANNOT_DB	 = "user_x.drug_change_64ante_lab_db";
	static String DRUG_CHG_ANNOT_MS	 = "user_x.drug_change_63ante_lab_ms";
	static String CONTI_ANNOT 		 = "user_x.continuation_"+YEAR+"_ante_lab";
	...
	public static void main(String[] args) throws ClassNotFoundException, SQLException {
		...
		if(REF.equals(REF_DRUG)){
			DOSE_DOWN_PHENO 	 = "user_x.dose_down_"+YEAR+"_ante_lab_p450_all";
			DOSE_UP_PHENO 	     = "user_x.dose_up_"+YEAR+"_ante_lab_p450_all";
			DRUG_CHG_PHENO_DB	 = "user_x.drug_change_"+YEAR+"_ante_lab_db_p450_all";
			DRUG_CHG_PHENO_MS	 = "user_x.drug_change_"+YEAR+"_ante_lab_ms_p450_all";
		}else if(REF.equals(ALL)){
			DOSE_DOWN_PHENO 	 = "user_x.dose_down_"+YEAR+"_ante_lab_p450_pr_all";
			DOSE_UP_PHENO 	     = "user_x.dose_up_"+YEAR+"_ante_lab_p450_pr_all";
			DRUG_CHG_PHENO_DB	 = "user_x.drug_change_"+YEAR+"_ante_lab_db_p450_pr_all";
			DRUG_CHG_PHENO_MS	 = "user_x.drug_change_"+YEAR+"_ante_lab_ms_p450_pr_all";
		}
		Date start 			= new Date();
