...
public class ComputeAnteIcdDiagProfile6_all {
	...
	static String DOSE_CHG_ANNOT 	 = "user_x.dose_change_"+YEAR+"_ante_icd_m";
	...
	static String CONTI_ANNOT 		 = "user_x.continuation_"+YEAR+"_ante_icd_m";
	...
	public static void main(String[] args) throws ClassNotFoundException, SQLException {
		...
		if(REF.equals(REF_DRUG)){
			DOSE_DOWN_PHENO 	 = "user_x.dose_down_"+YEAR+"_ante_icd_p450_all";
			DOSE_UP_PHENO 	     = "user_x.dose_up_"+YEAR+"_ante_icd_p450_all";
			DRUG_CHG_PHENO_DB	 = "user_x.drug_change_"+YEAR+"_ante_icd_db_p450_all";
			DRUG_CHG_PHENO_MS	 = "user_x.drug_change_"+YEAR+"_ante_icd_ms_p450_all";
		}else if(REF.equals(ALL)){
			DOSE_DOWN_PHENO 	 = "user_x.dose_down_"+YEAR+"_ante_icd_p450_pr_all";
			DOSE_UP_PHENO 	     = "user_x.dose_up_"+YEAR+"_ante_icd_p450_pr_all";
			DRUG_CHG_PHENO_DB	 = "user_x.drug_change_"+YEAR+"_ante_icd_db_p450_pr_all";
			DRUG_CHG_PHENO_MS	 = "user_x.drug_change_"+YEAR+"_ante_icd_ms_p450_pr_all";
		}
		Date start 			= new Date();
