...
public class ComputeAntePhenotypeProfile6_all {

	static String YEAR 	 	 		 = "2008_2013" ; // 2008_2013 or 2014
	static String DRUG_TABLE 	 	 = "user_x.p450" ; //"user_x.drug_and_drug_class";
	static String DOSE_CHG		 	 = "user_x.dose_change_"+YEAR+"_m";
	static String DOSE_CHG_ANNOT 	 = "user_x.dose_change_"+YEAR+"_ante_annotation_m";
	static String DRUG_CHG_ANNOT_DB	 = "user_x.drug_change_64ante_annotation_db";
	static String DRUG_CHG_ANNOT_MS	 = "user_x.drug_change_63ante_annotation_ms";
	static String CONTI_ANNOT 		 = "user_x.continuation_"+YEAR+"_ante_annotation_m";
	...
	static String REF_DRUG			 = "single_drug";//"same_drug_continuation";
	...
	public static void main(String[] args) throws ClassNotFoundException, SQLException {
		...
		// ========================= PRELIM   =========================
		// ============================================================
		int cuiToStartWith = Integer.parseInt(args[0]);   // 0
		...
		if(REF.equals(REF_DRUG)){
			DOSE_DOWN_PHENO 	 = "user_x.dose_down_"+YEAR+"_ante_phenotype_p450_all";
			DOSE_UP_PHENO 	     = "user_x.dose_up_"+YEAR+"_ante_phenotype_p450_all";
			DRUG_CHG_PHENO_DB	 = "user_x.drug_change_"+YEAR+"_ante_phenotype_db_p450_all";
			DRUG_CHG_PHENO_MS	 = "user_x.drug_change_"+YEAR+"_ante_phenotype_ms_p450_all";
		}else if(REF.equals(ALL)){
			DOSE_DOWN_PHENO 	 = "user_x.dose_down_"+YEAR+"_ante_phenotype_p450_pr_all";
			DOSE_UP_PHENO 	     = "user_x.dose_up_"+YEAR+"_ante_phenotype_p450_pr_all";
			DRUG_CHG_PHENO_DB	 = "user_x.drug_change_"+YEAR+"_ante_phenotype_db_p450_pr_all";
			DRUG_CHG_PHENO_MS	 = "user_x.drug_change_"+YEAR+"_ante_phenotype_ms_p450_pr_all";
		}
		Date start 			= new Date();
