...
public class ComputeAnteLabProfile6_all {
	...
	static String CONTI_ANNOT 		 = "user_x.continuation_64ante_lab";
	...
	static String REF 				 = "single_drug";// "single_drug";
	...
	public static void main(String[] args) throws ClassNotFoundException, SQLException {
		...
		if(REF.equals(DRUG_REF)){
			DOSE_DOWN_PHENO 	 = "user_x.dose_down_65ante_lab_p450_all";
			DOSE_UP_PHENO 	     = "user_x.dose_up_65ante_lab_p450_all";
			DRUG_CHG_PHENO_DB	 = "user_x.drug_change_65ante_lab_db_p450_all";
			DRUG_CHG_PHENO_MS	 = "user_x.drug_change_65ante_lab_ms_p450_all";
		}else if(REF.equals(ALL)){
			DOSE_DOWN_PHENO 	 = "user_x.dose_down_65ante_lab_p450_pr_all";
			DOSE_UP_PHENO 	     = "user_x.dose_up_65ante_lab_p450_pr_all";
			DRUG_CHG_PHENO_DB	 = "user_x.drug_change_65ante_lab_db_p450_pr_all";
			DRUG_CHG_PHENO_MS	 = "user_x.drug_change_65ante_lab_ms_p450_pr_all";
		}
		Date start 			= new Date();
