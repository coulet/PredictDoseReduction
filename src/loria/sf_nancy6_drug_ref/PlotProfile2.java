...
/**
 * order by Risk Ratio instead of pvalue
 * @author coulet
 *
 */
...
public class PlotProfile2 {
	...
	public static void main(String[] args) throws InterruptedException, IOException, SQLException, ClassNotFoundException {
		...
		String singleDrug = "single";//"class";//args[0]; //single or class
		String upOrDown = "up"; //args[1] //up or down
	...
	public static void plotProfile(String table, String attribute, String var, String upOrDown) throws InterruptedException {
		...
		*/
		...
		try {
			shell2 = Runtime.getRuntime().exec(new String[] {"/usr/local/bin/convert","./data/profile/order_by_rr/"+table+"_profile_"+upOrDown+"_"+var+".png",
					"-rotate","90","./data/profile/order_by_rr/"+table+"_profile_"+upOrDown+"_"+var+".png"});
