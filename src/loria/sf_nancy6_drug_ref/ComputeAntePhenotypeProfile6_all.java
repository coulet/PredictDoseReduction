...
public class ComputeAntePhenotypeProfile6_all {
	...
	static String DOSE_CHG_ANNOT 	 = "user_x.dose_change_64ante_annotation_m";
	...
	static String CONTI_ANNOT 		 = "user_x.continuation_64ante_annotation_m";
	...
	static String DRUG_REF		 	 = "single_drug";//"same_drug_continuation";
	static String REF 				 = "single_drug";// "all_drugs";
	...
	public static void main(String[] args) throws ClassNotFoundException, SQLException {
		...
		if(REF.equals(DRUG_REF)){
			DOSE_DOWN_PHENO 	 = "user_x.dose_down_65ante_phenotype_p450_all";
			DOSE_UP_PHENO 	     = "user_x.dose_up_65ante_phenotype_p450_all";
			DRUG_CHG_PHENO_DB	 = "user_x.drug_change_65ante_phenotype_db_p450_all";
			DRUG_CHG_PHENO_MS	 = "user_x.drug_change_65ante_phenotype_ms_p450_all";
		}else if(REF.equals(ALL)){
			DOSE_DOWN_PHENO 	 = "user_x.dose_down_65ante_phenotype_p450_pr_all";
			DOSE_UP_PHENO 	     = "user_x.dose_up_65ante_phenotype_p450_pr_all";
			DRUG_CHG_PHENO_DB	 = "user_x.drug_change_65ante_phenotype_db_p450_pr_all";
			DRUG_CHG_PHENO_MS	 = "user_x.drug_change_65ante_phenotype_ms_p450_pr_all";
		}
		Date start 			= new Date();
